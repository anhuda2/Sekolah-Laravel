...
@section('content')
    ...
    <div class="flex flex-row justify-between w-64">
        ...
        <div class="text-sm text-left text-gray-600 py-2 px-4 font-semibold">
            @if ($attendance->attendence_status == 'hadir')
                <span class="text-xs text-white bg-green-500 px-2 py-1 rounded-custom">Hadir</span>
            @elseif ($attendance->attendence_status == 'absen')
                <span class="text-xs text-white bg-red-500 px-2 py-1 rounded-custom">Alfa</span>
            @elseif ($attendance->attendence_status == 'sakit')
                <span class="text-xs text-white bg-yellow-500 px-2 py-1 rounded-custom">Sakit</span>
            @elseif ($attendance->attendence_status == 'izin')
                <span class="text-xs text-white bg-blue-500 px-2 py-1 rounded-custom">Izin</span>
            @else
                <span class="text-xs text-white bg-gray-500 px-2 py-1 rounded-custom">-</span>
            @endif
        </div>
    </div>
@endforeach
