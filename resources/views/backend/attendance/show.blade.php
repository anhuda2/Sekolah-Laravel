    ...
    <div class="flex items-center justify-between border border-gray-200">
        ...
        <div class="w-3/12 text-xs text-right text-gray-600 py-2 px-4 font-semibold">
            @if ($attendance->attendence_status == 'hadir')
                <span class="bg-green-600 text-white px-2 py-1 rounded-custom">H</span>
            ...
            @elseif ($attendance->attendence_status == 'sakit')
                <span class="bg-yellow-500 text-white px-2 py-1 rounded-custom">S</span>
            @elseif ($attendance->attendence_status == 'izin')
                <span class="bg-blue-500 text-white px-2 py-1 rounded-custom">I</span>
            @else
                <span class="bg-gray-500 text-white px-2 py-1 rounded-custom">-</span>
            @endif
        </div>
    </div>
@endforeach
