    ...
    <span class="text-xs text-white bg-green-500 px-2 py-1 rounded-custom">H</span>
...
@elseif($attendance->attendence_status == 'sakit')
    <span class="text-xs text-white bg-yellow-500 px-2 py-1 rounded-custom">S</span>
@elseif($attendance->attendence_status == 'izin')
    <span class="text-xs text-white bg-blue-500 px-2 py-1 rounded-custom">I</span>
@endif
                    </div>
                </div>
            @endforeach
